...
#### 2.1 What is the difference between function declaration and function expression?
...
#### 2.3 What is the `this` keyword in JavaScript, and how does it work?
...
#### 2.4 What is the difference between `call`, `apply`, and `bind`?
...
#### 3.1 What is a Promise and Why is it Needed?
...
#### 3.6 What is a Callback Function and Why Do We Need Callbacks?
...
#### 4.1 What are Events in JavaScript?
